...
```bash
pip install langgraph langchain langchain-core langchain-community langchain-groq tavily-python fastapi uvicorn pydantic streamlit plotly requests streamlit-autorefresh python-jose[cryptography] bcrypt slack_bolt python-multipart
...
![Main Dashboard (Home)](https://github.com/user-attachments/assets/582cace1-c51f-43eb-9a52-73f1d0340ffe)

### Insight Casual Reasoning and Recommendations

![Insight Casual Reasoning and Recommendations](https://github.com/user-attachments/assets/026c08b5-0772-458b-8180-c4449fee9d8d)

### Simulation Sandbox (Operations Example)

![Simulation Sandbox (Operations Example 1)](https://github.com/user-attachments/assets/1a2e7de3-f99c-4682-b717-8b122126e457)

![Simulation Sandbox (Operations Example 2)](https://github.com/user-attachments/assets/309e9872-48b7-4311-9cb4-e35ee59b6d91)

### Slack Chat Feature

![Slack Chat Feature](https://github.com/user-attachments/assets/79016c7d-f9fa-412b-a6b4-91cf6b64ed8b)
